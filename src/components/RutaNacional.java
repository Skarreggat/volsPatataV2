...
public class RutaNacional extends Ruta {
	 ...
	 * una nova ruta nacional. Les dades a demanar són les que necessita el
	 * constructor. - Heu de tenir en compte que els aeroports no tene per què estar
	 * formats per una única paraula, per exemple, El Prat.
	 */
