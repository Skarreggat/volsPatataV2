...
public class RutaTransoceanica extends RutaIntercontinental {
	 ...
	 */
	public RutaTransoceanica(String codi, String aeroportOri, String aeroportDes, String paisOri, String paisDes,
			String continentOri, String continentDes, String ocea, double distancia) {
	 ...
	 * una nova ruta transcoceanica. Les dades a demanar són les que necessita el
	 * constructor. - Heu de tenir en compte que els aeroports i països no tene per
	 * què estar formats per una única paraula, per exemple, El Prat i Regne Unit.
	 */
	public static RutaTransoceanica novaRutaTransoceanica() {
		...
		return new RutaTransoceanica(codi, aeroportOri, aeroportDes, paisOri, paisDes, continentOri, continentDes, ocea,
				distancia);
	}
	...
	public void modificarRutaTransoceanica() {
		...
		ocea = (String) demanarDades("\nQuin és el nou oceà que sobrevola la ruta transoceànica?", 2);
